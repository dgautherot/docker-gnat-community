...
# --------------------------------------------------------------------------- #
.PHONY: image-x86_64-linux push-to-github-x86_64-linux clean-x86_64-linux

image-x86_64-linux:
	$(DOCKER) build -f $(DOCKER_FILE_FOR_X86_64_LINUX) -t $(GNAT_COMMUNITY):$(TAG_NAME_FOR_X86_64_LINUX) .

push-to-github-x86_64-linux:
...
# --------------------------------------------------------------------------- #
.PHONY: images clean push-to-github
...
push-to-github: push-to-github-x86_64-linux
